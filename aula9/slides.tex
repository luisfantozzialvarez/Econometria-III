...
\begin{itemize}
	...
	\item Restrições de sinal: FRIs da taxa de juros, deflator do PIB, índice de preços de commodities e reservas próprias a um choque monetário contracionista são menores ou iguais a zero, nos horizontes 0 a 5.  
\end{itemize}
\end{frame}
