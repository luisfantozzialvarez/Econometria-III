...
\begin{frame}{Função de resposta ao impulso}
	...
	\end{itemize}
	\item Formalmente, o efeito \textit{ceteris-paribus} de uma surpresa de uma unidade na $j$-ésima inovação do sistema em $t$, $\epsilon_{jt}$, sobre a $i$-ésima variável do sistema em $t+h$, $h\geq 0$, é dada pela {\color{blue}função de resposta ao impulso}
