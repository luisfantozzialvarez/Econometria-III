...
\begin{frame}{Alternativas ao filtro HP: \citet{Hamilton2019}}
	\begin{halfwideitemize}
		...
		\begin{itemize}
			...
			\item Medida captura o erro que se comete em projetar o que em $t$, com base no que ocorreu há dois anos.
			\item Ideia é que esse erro capturaria fatores cíclicos.
		\end{itemize}
	\end{halfwideitemize}
\end{frame}

\begin{frame}{Aplicação de \cite{Hamilton2019} aos dados de desemprego}
	conteúdo...
\end{frame}
