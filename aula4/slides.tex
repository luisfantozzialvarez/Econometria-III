...
\begin{frame}{\citet{Elliott1996} }
	\begin{itemize}
		...
		\item Os autores verificam que o poder do teste ADF nos modelos \eqref{eq_drift} e \eqref{eq_full} pode ser baixo
		\begin{itemize}
		...
		\end{itemize}
		\item Proposta de ERS: remover os componentes determinísticos numa etapa preliminar, estimando o modelo \eqref{eq_drift} ou \eqref{eq_full} \textbf{impondo que} $\gamma = c/T$ para uma constante $c >0$, e rodar o teste ADF nos dados \textit{detrended}.
