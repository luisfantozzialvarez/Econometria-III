...
\begin{frame}{Motivação do teste ADF}
	...
	\begin{itemize}
		...
		\begin{equation*}
			...
			\end{aligned}
		\end{equation*}
		\item Ideia de \citet{Said1984}: se polinômio $\Theta$ apresenta todas as raízes fora do círculo, então dependência em $\sum_{j=1}^\infty \pi_j \epsilon_{t-j}$ é bem aproximável, sob a nula, por termo da forma $\sum_{j=1}^k \rho_j \Delta y_{t-j}$ para algum $k$. \hfill  \hyperlink{main_adf}{\beamerreturnbutton{Retornar à aula}} 
	\end{itemize}
