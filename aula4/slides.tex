...
\begin{frame}{Alternativa de \citet{Phillips1988}}
	\begin{itemize}
		...
		\begin{itemize}
			\item Teste parece funcionar pior que o ADF em diversas simulações.
			\item Por esse motivo, não focaremos nele no curso.
		\end{itemize} 
...
\begin{frame}{Procedimento Sequencial I}
	\begin{wideenumerate}
		...
		Teste $H_0: \gamma = 0$ contra alternativa de que $H_1: \gamma < 0$ usando estatística $\hat{t}$ e os valores críticos não normais para esse caso (\textit{slide} 10, caso 4).
		\begin{halfwideenumerate}
...
\begin{frame}{Procedimento Sequencial II}
	\begin{wideenumerate}
		...
		Teste $H_0: \gamma = 0$ contra alternativa de que $H_1: \gamma < 0$ usando estatística $\hat{t}$ e valores críticos não normais para esse caso (\textit{slide} 10, caso 2).
		\begin{halfwideenumerate}
