...
\begin{frame}{Estimação incondicional do ARMA(p,q)}
	\begin{itemize}
		...
		\end{itemize}
		\item Se ruído branco de fato é Gaussiano, estimador é {\color{blue}eficiente}: dentre todos os estimadores consistente dos parâmetros um ARMA(p,q) Gaussiano, estimador é o de menor variância.
